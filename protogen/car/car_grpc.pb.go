...
func (c *carServiceClient) GetCarByID(ctx context.Context, in *GetCarByIDRequest, opts ...grpc.CallOption) (*GetCarByIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/CarService/GetCarByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *carServiceClient) GetCarList(ctx context.Context, in *GetCarListRequest, opts ...grpc.CallOption) (*GetCarListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/CarService/GetCarList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CarService_GetCarByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/CarService/GetCarByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CarService_GetCarList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/CarService/GetCarList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var CarService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "rentcar_protoc/car.proto",
}
